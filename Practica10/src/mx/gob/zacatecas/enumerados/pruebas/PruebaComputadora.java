...
public class PruebaComputadora{
	public static void main(String[] args) {
		Computadora comp1 = new Computadora("Asus", Memoria.DDR);
		Computadora comp2 = new Computadora("Lenovo", Memoria.DDR2);
		Computadora comp3 = new Computadora("Dell", Memoria.DDR3);
		Computadora comp4 = new Computadora("HP", Memoria.DDR4);
